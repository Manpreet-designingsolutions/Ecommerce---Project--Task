  ...
  return (
    <>
      <div className='h-full w-full  mt-2 flex   '>
        <div className='h-full w-3/5   flex flex-col   gap-2 mt-2'>
        {
        ...
        <div className='h-48 w-2/5 mt-5 flex flex-col items-center'>
          ...
          <p className='text-5xl font-bold text-green-800 py-2'>SUMMARY</p>
          ...
          <button className='bg-green-600 font-extrabold text-lg text-white rounded-lg p-1 w-48 mt-2' onClick={handleCheckout}>Checkout now</button>
        </div>
      </div>
    </>
